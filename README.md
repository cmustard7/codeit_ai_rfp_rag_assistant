...
| 역할 | 담당자 | 핵심 업무 |
|------|--------|-----------|
| **Project Manager** | OOO | 프로젝트의 협업 과정을 매니징, 애자일/스프린트 방식으로 단위를 분리하고 회의를 주도, 성능 평가 |
| **데이터 처리 담당** | OOO | 문서별 메타데이터 처리, 문서 청킹 전략 설계 및 검증 |
| **Retrieval 담당** | OOO | 임베딩 생성 및 Vector DB 구축, 메타데이터 필터링 및 Retrieval 기법 고도화 |
| **Generation 담당** | OOO | 모델 선정 및 텍스트 생성 옵션 설정, 모델 응답 고도화, 대화 흐름 유지 및 히스토리 반영 전략 설계 |
